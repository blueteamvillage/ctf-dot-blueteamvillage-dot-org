...
import { Trophy, ArrowLeft, Crown, Medal, Star } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-navy via-navy-deep to-navy">
      ...
      <div className="relative pt-16 pb-16 px-4">
        <div className="absolute inset-0 bg-linear-to-r from-teal/10 to-teal/10"></div>
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="mb-8">
            <Link 
              href="/past-winners" 
              className="inline-flex items-center text-teal-bright hover:text-teal-bright transition-colors mb-6"
            >
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Past Winners
            </Link>
            <Badge className="bg-teal/20 text-teal-bright border-teal/30 mb-4">
              DEF CON 31 Champions
            </Badge>
            <h1 className="text-5xl md:text-7xl font-bold mb-4 bg-linear-to-r from-teal-bright via-teal-bright to-teal bg-clip-text text-transparent">
              DEF CON 31
            </h1>
            <h2 className="text-2xl md:text-3xl font-semibold text-teal-bright mb-6">Project Obsidian CTF Winners</h2>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-16">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-haze space-y-2">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="bg-navy-deep rounded-lg p-3">
                    <div className="text-teal-bright font-semibold">Multi-Stage Challenges</div>
                    <div className="text-haze text-sm">Complex scenarios requiring multiple skill sets</div>
                  </div>
                  <div className="bg-navy-deep rounded-lg p-3">
                    <div className="text-mint font-semibold">Real-World Scenarios</div>
                    <div className="text-haze text-sm">Based on actual cybersecurity incidents</div>
                  </div>
                  <div className="bg-navy-deep rounded-lg p-3">
                    <div className="text-gold font-semibold">Team Collaboration</div>
                    <div className="text-haze text-sm">Emphasis on teamwork and communication</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="bg-navy-card border-white/10 mb-8">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-mint">Legacy & Impact</CardTitle>
          </CardHeader>
          <CardContent>
